...
public class SettingsScreen extends InputAdapter implements Screen {
    ...
    public SettingsScreen(PirateFleetGame game) {
        this.game = game;
    }
    ...
    public void render(float delta) {
        ...
        renderer.circle(Constants.EASY_CENTER.x, Constants.EASY_CENTER.y, Constants.SETTINGS_BUBBLE_RADIUS);
        renderer.circle(Constants.MEDIUM_CENTER.x, Constants.MEDIUM_CENTER.y, Constants.SETTINGS_BUBBLE_RADIUS);
        renderer.circle(Constants.HARD_CENTER.x, Constants.HARD_CENTER.y, Constants.SETTINGS_BUBBLE_RADIUS);
        renderer.end();
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        if (worldTouch.dst(Constants.EASY_CENTER) < Constants.SETTINGS_BUBBLE_RADIUS) {
            game.showPirateFleetScreen();
        }

        if (worldTouch.dst(Constants.MEDIUM_CENTER) < Constants.SETTINGS_BUBBLE_RADIUS) {
            game.showPirateFleetScreen();
        }

        if (worldTouch.dst(Constants.HARD_CENTER) < Constants.SETTINGS_BUBBLE_RADIUS) {
            game.showPirateFleetScreen();
        }
